        ...
        <div class="attendance">
            <div class="top">
                <div class="title">  
                    ...
                    <span class="all"><i class="el-icon-arrow-right"></i>全部</span>
                </div>
                <ul class="set">
                    <li><el-button type="text" @click="dialogFormVisible = true">新建</el-button></li>
                    <li class="middle"><el-button type="text">全部</el-button></li>
